...
const validationsForm = (form) => {
  ...
  if (!form.description.trim()) {
    ...
    errors.description = "El campo descripcion es incorrecto";
  }
      ...
      <form onSubmit={handleSubmit} className="">
        ...
        <div className="form-floating mb-3 mt-5">
          <textarea
            ...
            required
          ></textarea>
          <label htmlFor="description" className="fw-light">Descripcion</label>
        </div>
        {errors.description && (
          <Message msg={errors.description} bgColor={bgColors.warning} />
        )}
...
export default memo(FormCatalog);
